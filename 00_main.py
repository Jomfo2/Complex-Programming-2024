...
class Converter:
    def __init__(self):
        ...
        # Debug Btn
        self.debug_button = Button(self.entry_frame, text="Debug Button", command=self.debug)
        self.debug_button.grid(row=2, column=0)

    def debug(self):
        # Change the text of the entry widget
        new_text = self.selected_input.get()
        self.input_entry.delete(0, END)  # Delete current text in the entry
        self.input_entry.insert(0, new_text)  # Insert new text
